...
(function($, window, undefined){
  ...
  Hangman = {
    ...
    win: function(){
      ...
      this.msgTitle.html("Yeay selamat Mas Bimo!! pinter banget cowok acu");
      // this is messy
      this.showMsg();
    ...
    lose: function(){
      this.msgTitle.html("Gimana sih mas.. Harusnya kan <span class='highlight'>"+ this.wrd.word +"</span>");
      this.msgText.html("Yaudah, reload habis itu coba lagi");
      this.showMsg();
    }
